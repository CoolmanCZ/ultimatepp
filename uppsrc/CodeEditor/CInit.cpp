...
void CSyntax::InitKeywords()
{
	...
	static const char *sch[] = {
		...
		"UUID", "UUID_", "UUID_ARRAY", "UUID_ARRAY_",
		...
		"TYPE_", "TYPE_I_", "TYPE_II_", "TYPE_III_", "SERIAL", "SERIAL_", "ISERIAL", "ISERIAL_",
		"BIGSERIAL", "BIGSERIAL_", "TEXT", "TEXT_RRAY", "TEXT_", "TEXT_ARRAY_",
